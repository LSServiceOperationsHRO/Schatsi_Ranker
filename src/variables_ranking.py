...
# For SCHATSI_RANKER the Output-folder of the SCHATSI_Datacleanser has to be the Input-folder
...
SCHATSI_TERMS = os.path.join(SCHATSI_INPUT_FOLDER, "schatsi_terms.csv")
